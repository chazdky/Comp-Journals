...
\caption{IPv6 Configuration}\label{config3V6}
\end{figure}
...
\noindent We can now see in Fig~\ref{config3V6}\subref{config3V6layout} that PC3 PC4 and R2 are all connected to each other. 
...
\begin{figure}[!hbt]\centering
  ...
  \caption{Verifying Connectivity of the Network}\label{Verify3V6}
\end{figure}
